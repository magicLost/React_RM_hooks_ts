...
export const getController = (
  ...
  switch (pageType) {
    ...
    default:
      throw new Error("No implementation for type " + pageType);
  }
};
...
export const usePage = (
  ...
  const controllerRef: React.MutableRefObject<IPageController<
    IClasses
  > | null> = useRef(null);
  ...
  useEffect(() => {
    ...
    window.addEventListener(
      "popstate",
      controllerRef.current.onPopstate,
      false
    );

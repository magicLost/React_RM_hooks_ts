import RCarouselController from "../../RCarouselController";
import { calcDecreasedIndex, calcIncreasedIndex } from "../../../../../utility/utility";
import {CarouselTranslateState, CarouselState, CarouselAction} from "../../../../../hooks/Carousels/RCarousel/rcarousel";
//import { clamp } from "../../../../../helper/MathF";


class RCarouselTranslateController extends RCarouselController {
    ...
    pointerMoveAC = (state: CarouselState, action: CarouselAction) => {
        ...
        this.calc.onPointerMove(action.pageX, action.pageY, state.activeIndex, this.itemsLength);
...
export default RCarouselTranslateController;